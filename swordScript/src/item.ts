...
export default class Button implements IScript<Props> {
  ...
  clip = new AudioClip('swordScript/sounds/use.mp3')
  equipClip = new AudioClip('swordScript/sounds/SwordEquip.mp3')
  canvas = new UICanvas()
  container = new UIContainerStack(this.canvas)
  texture = new Texture('swordScript/images/iron_sword_png.png')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    key.addComponent(new GLTFShape('swordScript/models/Sword_02.glb'))
    key.addComponent(
      new OnPointerDown(
        () => {
